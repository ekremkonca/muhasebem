...
const MONEY_RE=/-?(?:(?:₺|\$|€|£)\s*[\d.\u00a0\u202f ]+(?:,\d{1,2})?|[\d.\u00a0\u202f ]+(?:,\d{1,2})?\s*(?:₺|\$|€|£))/g;
...
export default function ThemeSwitcher(){
 const[theme,setTheme]=useState('classic'),[open,setOpen]=useState(false),[hidden,setHidden]=useState(()=>{try{return localStorage.getItem(PRIVACY_KEY)==='1'}catch{return false}}),ref=useRef();
 ...
 const current=THEMES.find(x=>x[0]===theme);
