...
export default function HeaderSettings({children}){
 ...
 return <div className="unified-settings" ref={ref}><button className="icon-btn unified-settings-trigger" type="button" aria-label="Ayarlar ve araçlar" aria-expanded={open} onClick={()=>setOpen(!open)}><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><path d="m9 3-1 3-3 1-2 3 2 2-1 3 3 2 3-1 2 3 3-1 1-3 3-1 2-3-2-2 1-3-3-2-3 1-2-3z"/><circle cx="12" cy="11" r="3"/></svg></button><div className="unified-settings-panel" hidden={!open}><strong>Ayarlar ve araçlar</strong>{children}</div></div>
}
